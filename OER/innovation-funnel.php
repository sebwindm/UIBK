...
<!-- 			<div id="imageIntro"><img id="imageIntroFile" src="./images/SVGs/intro.svg" width="200px" onclick="showIntro()" style="padding-bottom: 120px;border: 0.5px dotted black" /></div> -->
			<div id="imageOne1"><img id="imageOneFile" src="./images/SVGs/phase1.svg" width="200px" onclick="showPhaseOne()" /></div>
			<div id="imageTwo1"><img id="imageTwoFile" src="./images/SVGs/phase2-blur.svg" width="200px" onclick="showPhaseTwo()" style="margin-top: 8px"></div>
			<div id="imageThree1"><img id="imageThreeFile" src="./images/SVGs/phase3-blur.svg" width="200px" onclick="showPhaseThree()" style="margin-top: 3px"></div>
			<div id="imageFour1"><img id="imageFourFile" src="./images/SVGs/phase4-blur.svg" width="200px" onclick="showPhaseFour()" style="margin-top: 3px"></div>
		</div>
	</section>
