...
<div style="clear: both;">
	...
	<!-- 			<div id="imageIntro"><img id="imageIntroFile" src="./images/SVGs/intro.svg" width="200px" onclick="showIntro()" style="padding-bottom: 120px;border: 0.5px dotted black" /></div> -->
	    ...
	    <div id="imageFour1"><a href="innovation-funnel-phase-4.php"><img id="imageFourFile" src="./images/SVGs/phase4.svg" width="170px"  style="margin-top: 5px"></a></div>
	  </div>
	  <br />

		<span><a href="innovation-funnel-phase-3.php">
			<img src="./images/SVGs/arrow-backward.svg"/>Previous phase
		</a></span>
				<a href="innovation-funnel-phase-1.php"><img src="./images/SVGs/first-page.svg"/><span>First phase</span></a>
	</section>
